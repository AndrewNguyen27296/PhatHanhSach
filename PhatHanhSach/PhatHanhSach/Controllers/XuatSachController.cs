...
namespace PhatHanhSach.Controllers
{
    public class XuatSachController : Controller
    {
        ...
        public ActionResult Details(int? MaPX)
        {
        ...
        public ActionResult ThemChiTiet(SACH sach, FormCollection f)
        {
            ...
            {
                return Content("<script>alert('SL sách trong kho không đáp ứng đủ SL yêu cầu'); window.location.href = '/XuatSach/XuatSach'</script>");
            }
